public class Principal {
    public static void main(String[] args) {
        ...
        Producto p4 = new Producto("Producto Cuatro","CP-004",4.50);
        Producto p5 = new Producto("Producto Cinco","CP-005",5.50);
        Producto p6 = new Producto("Producto Cinco","CP-006",6.50);
        Producto p7 = new Producto("Producto Cinco","CP-007",7.50);
